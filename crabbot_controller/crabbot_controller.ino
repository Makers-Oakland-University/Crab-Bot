/*  crabbot controller
    ...
    derived from the makers controller library's basic_transmitter_oled.ino example 
    ...
    See Github page for more information about the controller library https://github.com/Makers-Oakland-University/Makers-Unified-Controller-Arduino
*/
...
void setup() {
  ...
  String targetDeviceMAC = "30:C6:F7:29:52:54";
...
void loop() {
  ...
  //print the connection strength
  display.print("Connection "); 
  display.print(controller.getSuccessfulTransmissionPercentage());
  display.println("%");
